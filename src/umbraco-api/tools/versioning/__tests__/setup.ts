/**
 * Versioning Collection Test Setup
 */
...
interface VersioningTestState {
  testPageId: string;
}

let cachedState: VersioningTestState | null = null;

export async function initVersioningTestState(
  extra: Parameters<typeof listChildrenTool.handler>[1],
): Promise<VersioningTestState> {
